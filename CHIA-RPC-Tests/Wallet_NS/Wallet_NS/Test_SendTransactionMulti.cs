...
{
    public class Test_SendTransactionMulti
    {
        ...
        {
           throw new NotImplementedException("cant be validated due to missing documentation on https://docs.chia.net/wallet-rpc#send_transaction_multi");
