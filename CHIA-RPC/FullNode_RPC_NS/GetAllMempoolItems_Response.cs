...
namespace CHIA_RPC.FullNode_RPC_NS
{
    ...
    public class GetBlockchainState_Response
    {
        ...
        /// <summary>
        /// boolean indicating wether the server accepted and processed the request successfully
        /// </summary>
        public bool success { get; set; }
        /// <summary>
        /// in case the server refuses the request, it will add a more or less helful error message here.
        /// </summary>
