...
namespace CHIA_RPC.FullNode_RPC_NS
{
    ...
    public class GetBlockRecord_Response
    {
        ...
        public static GetBlockRecord_Response LoadResponseFromFile(string filePath)
        {
            return RpcFileManager.LoadObjectFromFile<GetBlockRecord_Response>(filePath);
        }
    ...
    public class GetBlockRecords_Response
    {
        ...
        /// <param name="filePath">The path to load the response from.</param>
        /// <returns>The loaded response.</returns>
        public static GetBlockRecords_Response LoadResponseFromFile(string filePath)
        {
            return RpcFileManager.LoadObjectFromFile<GetBlockRecords_Response>(filePath);
        }
