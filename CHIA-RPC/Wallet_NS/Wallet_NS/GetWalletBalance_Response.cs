...
namespace CHIA_RPC.Wallet_NS.Wallet_NS
{
    ...
    {
        /// <summary>
        /// represents the total balance which is in the wallet *right now*, <br/>
        /// in mojo.
        /// </summary>
        ...
        /// <summary>
        /// The amount of pending change, which representsthe balance change when all pending transactions are completed.<br/>
        ...
        /// <summary>
        /// represents the presumed total balance which is in the wallet, including unconfirmed transactions<br/>
        /// in other words: <br/>
