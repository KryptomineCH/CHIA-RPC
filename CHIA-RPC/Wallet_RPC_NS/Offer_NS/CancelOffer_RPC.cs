...
namespace CHIA_RPC.Wallet_RPC_NS.Offer_NS
{
    ...
    /// </summary>
    /// <remarks>Returns a success response</remarks>
    public class CancelOffer_RPC : RPCTemplate<CancelOffer_RPC>
    {
        ...
        /// <summary>
        /// Defaults to True, which means "cancel on blockchain," ie spend the coins being offered and create new coin's in the Maker's wallet. Set to False to cancel locally. See cancellation for more info.
        /// </summary>
