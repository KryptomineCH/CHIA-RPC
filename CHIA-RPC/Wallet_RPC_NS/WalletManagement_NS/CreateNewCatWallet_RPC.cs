...
{
    public class CreateNewCatWallet_RPC
    {
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        public static CreateNewCatWallet_RPC Load(string path)
        {
            FileInfo testFile = new FileInfo(path);
            string text = File.ReadAllText(testFile.FullName);
            CreateNewCatWallet_RPC rpc = JsonSerializer.Deserialize<CreateNewCatWallet_RPC>(text);
            return rpc;
        }
        /// <summary>
